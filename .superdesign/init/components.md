...
Framework: React 18 + TypeScript. Styling: Tailwind CSS with Radix primitives and `class-variance-authority`.

## `src/components/ui/button.tsx` — Button

Reusable button with default, destructive, outline, secondary, ghost, and link variants.
...
## `src/components/ui/card.tsx` — Card family
...
Task-specific form controls, table cells, kanban cards, the task detail drawer, and the conversation composer currently live directly inside `src/components/TasksPage.tsx`.
